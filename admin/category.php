...
<div class="controls">
<input type="text" placeholder="Inserte nombre de la categoria"  name="category" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="category.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('estas seguro de querer borrarla?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>

...
<div class="logo">
	...
	<div class="control-group">
		<h4><img height="50" width="50" data-echo="assets/icon.png" src="assets/images/icon.png" alt="">&nbsp; Afrodita J&A SexShop</h4>
	</div>
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price">COP.<?php echo ($row['productPrice']+$row['shippingCharge']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?></div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>COP.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>

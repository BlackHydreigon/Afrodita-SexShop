...
<div class="controls">
<input type="text"    name="productName"  placeholder="Inserte nombre del producto" value="<?php echo htmlentities($row['productName']);?>" class="span8 tip" >
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Compañia fabricante</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Inserte el nombre de la compañia" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Precio del producto antes del descuento</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Inserte el precio del producto" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<input type="text"    name="productprice"  placeholder="Inserte precio del producto" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Inserte descripcion del producro" rows="6" class="span8 tip">
...
<div class="control-group">
<label class="control-label" for="basicinput">Precio del envio </label>
<div class="controls">
<input type="text"    name="productShippingcharge"  placeholder="Inserte precio del envio" value="<?php echo htmlentities($row['shippingCharge']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">Imagen del producto2</label>
<div class="controls">

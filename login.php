...
{
alert("LA contraseña y la confirmacion de la contraseña no coinciden");
...
<div class="col-md-6 col-sm-6 sign-in">
	<h4 class="">Inicia sesion</h4>
	<p class="">Bienvenido, Ingrese con su cuenta</p>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Crea tu propia cuenta para comprar.</p>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">Numero telefonico<span>*</span></label>
...
<div class="form-group">
	    	<label class="info-title" for="confirmpassword">Confirma contraseña. <span>*</span></label>
	    	<input type="password" class="form-control unicase-form-control text-input" id="confirmpassword" name="confirmpassword" required >
	  	</div>


	  	<button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button" id="submit">Registrarme</button>
	</form>
	<span class="checkout-subtitle outer-top-xs">  Registrate y podras:  </span>
	<div class="checkbox">
	  	<label class="checkbox">
		  	-Agilizar tu proceso de compra.
		</label>
		<label class="checkbox">
		    -Rastrear tus pedidos.
		</label>
		<label class="checkbox">
            -Tener un historial de todas tus.
		</label>
	</div>
</div>	

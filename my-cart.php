...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "COP"." ".$row['shippingCharge']; ?>.00</span></td>
...
$_SESSION['pid']=$pdtid;
	...
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Direcccion de compra</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Direccion de factiracion</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="col-md-4 col-sm-12 cart-shopping-total">
	...
	<?php } else {
echo "Tu carrito de compras esta vacio";
		}?>
</div>			</div>
		</div> 
		</form>

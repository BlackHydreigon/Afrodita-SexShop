...
<div class="controls">
<input type="text" placeholder="Nombre de la Subcategoria"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="Vuelve a confirmar('Estas seguro de que quieres eliminarla?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
